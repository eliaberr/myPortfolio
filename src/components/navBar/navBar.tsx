...
export function NavBar() {
    ...
    return (
        <nav>
            <div className="text-gray-300 grid-cols-12 hidden bg-[#1B1B1B] md:w-[1120px] md:grid h-[70px] mx-auto place-content-center rounded-b-xl">
                <OptionsNavBar />
                <SocialMidia />
            </div>
            <div className="grid md:hidden relative">
                <button
